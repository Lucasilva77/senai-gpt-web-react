...
function Chat() {
    ...
    const enviarMensagem = async (message) => {
        ...
        let novochatselecinado = { ...chatSelecionado };

        novochatselecinado.messages.push(novaMessagemusuaril);
        setChatSelecionado(novochatselecinado);
...
novochatselecinado.messages.push(novaMessagemBot);
